...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $("#service__card_1, #service__card_3, #service__card_5").hover(
      function () {
        $(".service").css(
          "background-image",
          "url(wp-content/themes/ramnet-theme/assets/images/service-bg.jpg)",
        );
      },
      function () {
        // Не убираем фон, так как в CSS есть базовый
      },
    );

    $("#service__card_2, #service__card_4, #service__card_6").hover(
      function () {
        $(".service").css(
          "background-image",
          "url(wp-content/themes/ramnet-theme/assets/images/service-bg2.jpg)",
        );
      },
      function () {
        // Не убираем фон, так как в CSS есть базовый
